...
INSERT INTO feeds (created_at, updated_at, name, url, user_id) VALUES ($1, $2, $3, $4, $5) RETURNING id, created_at, updated_at, name, url, user_id, last_fetched_at
`
...
const listNextFeedsToFetch = `-- name: ListNextFeedsToFetch :many
...
func (q *Queries) ListNextFeedsToFetch(ctx context.Context, limit int32) ([]Feed, error) {
	rows, err := q.db.QueryContext(ctx, listNextFeedsToFetch, limit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
